...
- [`KeyofDeep`](source/keyof-deep.d.ts) - Get deeply-nested keys from an object to use as a key path, like [Lodash's `.get()`](https://lodash.com/docs/latest#get) function input.
